...
public interface AttestationDnaRepository extends JpaRepository<AttestationDna,String> {
    @Query(value = "select \n" +
            "    U_CLE_P, \n"+
            "    CASE         \n" +
            ...
            ,nativeQuery = true)
    List<AttestationDna> findAttestationsDna(@Param("codeCompagnie") int codeCompagnie, @Param("dateDebut") Date dateDebut, @Param("dateFin") Date dateFin);
}
